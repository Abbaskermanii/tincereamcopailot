...
export default function InternalServerError() {
  return (
    <div className="mx-auto flex min-h-[55vh] max-w-xl flex-col items-center justify-center px-4 text-center">
      <p className="num-latin text-7xl font-extrabold text-lajvard">۵۰۰</p>
      <h1 className="mt-5 text-2xl font-bold">خطای سرور</h1>
      <p className="mt-3 text-ink-soft">
        متأسفانه مشکلی پیش آمده. لطفاً چند لحظه بعد تلاش کنید.
      </p>
